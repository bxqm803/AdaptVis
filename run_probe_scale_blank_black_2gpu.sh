...
ROOT_DIR="$(pwd)"
OUT_DIR="${ROOT_DIR}/output/relation_contribution_probe_blank_black"
...
grep -q "IMAGE_CONTROL" model_zoo/llava15.py
grep -q "blank_black" model_zoo/llava15.py
grep -q "apply_image_control_from_env" model_zoo/llava15.py
...
echo ""
echo "All blank-black probe jobs finished."
