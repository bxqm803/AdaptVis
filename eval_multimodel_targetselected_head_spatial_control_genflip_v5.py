...
# -*- coding: utf-8 -*-
"""
eval_multimodel_targetselected_head_spatial_control_genflip_v5.py
...
def run_pair(
    *, model_alias: str, dataset: str, model: Any, processor_or_backend: Any,
    ...
    print("Synthetic directions -> target GT selects head ID -> head prediction sets target -> minimum residual H/V step -> deepen score margin until ACTUAL generation flips -> binary-refine final step")
    ...
    meta = {
        ...
        "optimizer": "iterative_minimum_residual_generation_flip_with_margin_deepening",
