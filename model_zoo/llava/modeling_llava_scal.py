...
class LlavaForConditionalGenerationScal(LlavaPreTrainedModel):
    ...
    def forward(
        ...
        """
        AdaptVis-enabled LLaVA forward.

        Key behavior:
            - In prefill, image_id is generated by merging image features.
            - In decode, image_id is None.
            - For decode-step intervention, fall back to external keys:
        ...
        # In prefill, image_id comes from merged image features.
        # In decode, image_id is None, so continue using external keys.
        effective_keys = image_id if image_id is not None else keys
    ...
    def prepare_inputs_for_generation(
        ...
        **kwargs,
        ...
        # Keep AdaptVis / control arguments alive across generation steps.
        # This is required for decode-step intervention and w1/w2 to matter.
        model_inputs.update(
            {
