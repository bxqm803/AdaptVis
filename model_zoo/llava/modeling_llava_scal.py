...
class LlavaForConditionalGenerationScal(LlavaPreTrainedModel):
    ...
    def forward(
        ...
        # In the prefill step, image_id is generated by merging image features.
        # In decode steps, image_id is None, so we must keep using the original
        # image-token mask passed through generation kwargs.
        ...
        model_inputs.update(
            {
                ...
                # AdaptVis / VAR parameters.
                # These must be preserved across generation steps.
