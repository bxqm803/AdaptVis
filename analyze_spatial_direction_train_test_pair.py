#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Spatial direction codebook with pair-aware 30/70 train/test split.

Use case: evaluate spatial direction emergence on Controlled/VG/COCO datasets.\nKeep the original affine direction codebook and pair-aware split.
