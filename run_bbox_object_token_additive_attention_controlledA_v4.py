...
import analyze_controlledA_similarity_head_generation_step1_v1 as core
...
OUTPUT_DIR = Path("output/bbox_object_token_additive_attention_full_v4/controlled_A") / MODEL_NAME
...
def main():
    ...
    controlled_module = core.import_controlled_module()
    ...
    print(
        ...
        "BBOX-TARGETED ADDITIVE OBJECT-TOKEN ATTENTION V4"
    )
    print("=" * 170)
